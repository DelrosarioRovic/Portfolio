const logoProgLang = [
    ...
    },
    {
      ...
      delay: 1.7,
      src:
        "https://seeklogo.net/wp-content/uploads/2020/09/react-logo-512x512.png",
      alt: "React Logo",
    },
    {
      wrapperClassName: "w-20 h-20 absolute bottom-0 left-0 p-5 bg-green-900 bg-opacity-60 rounded-full",
      yValues:[0, -10, 0, 10, 0],
      true:true,
      delay: 2.4,
      src:
        "https://cdn.iconscout.com/icon/free/png-256/nodejs-1-1174935.png",
      alt: "Node.js Logo",
    },
  ];
